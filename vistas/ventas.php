        ...
        <div class="row mb-2">
            ...
            <div class="col-md-6">
                <ol class="breadcrumb float-md-right">
                    ...
                    <li class="breadcrumb-item">Transaciones</li>
...
<script>
    $(document).ready(function(){
        ...
        console.log("🚀 ~ file: ventas.php ~ line 97 ~ $ ~ ventas_desde", ventas_desde)
        ventas_hasta = ventas_hasta.substr(6,4) + '-' + ventas_hasta.substr(3,2) + '-' + ventas_hasta.substr(0,2) ;
        console.log("🚀 ~ file: ventas.php ~ line 99 ~ $ ~ ventas_hasta", ventas_hasta)
            ...
            drawCallback: function (settings) {
                ...
                api.column(groupColumn, {page:'current'} ).data().each( function ( group, i ) {                
                    ...
                    if ( last !== group ) {
                        ...
                        console.log("🚀 ~ file: ventas.php ~ line 134 ~ nroBoleta", nroBoleta)
